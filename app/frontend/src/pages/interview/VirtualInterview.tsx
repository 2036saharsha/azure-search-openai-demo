...
import styles from "./VirtualInterview.module.css";
...
export function Component(): JSX.Element {
    ...
    const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setSelectedFile(file || null); // Set the selected file in state
    };
    ...
    const uploadFile = async () => {
        ...
        if (selectedFile) {
            ...
            // No file selected, handle accordingly (e.g., show error message)
    ...
    return (
        <div className={styles.askContainer}>
            <div className={styles.askTopSection}>
                ...
                <h1 className={styles.askTitle}>Interview with Virtual Officer</h1>
                <div className={styles.askQuestionInput}>
                    ...
                    /> */}
                    <QuestionInput
                        placeholder="Example: Lets get you going for interview?"
                        disabled={isLoading}
                        initQuestion={transcript}
                        onSend={transcript => makeApiRequest(transcript)}
                    />
                </div>
            </div>

...
def test_chat(page: Page, live_server_url: str):
    ...
    page.get_by_placeholder("Type a new question (e.g. What is the weather like in DC?)").click()
    page.get_by_placeholder("Type a new question (e.g. What is the weather like in DC?)").fill(
...
def test_ask(page: Page, live_server_url: str):
    ...
    page.get_by_placeholder("Example: What is the weather like in DC?").click()
    page.get_by_placeholder("Example: What is the weather like in DC?").fill("Whats the dental plan?")
    page.get_by_placeholder("Example: What is the weather like in DC?").click()
    page.get_by_label("Ask question button").click()
